...
def __init__(
    ...
    tg_fn: Callable[[list[str], Any], TensorMask]
):
    store_attr()

@patch
def load_tensor(self: _MSDelegatingMaskGetter, mask_id: str, img_id: Any) -> TensorMask:
    return self.tg_fn(band_ids, img_id)

# %% ../../nbs/000_vision.load.ipynb 16
@patch(cls_method=True)
def from_files(
    cls: MSMaskGetter,
    files_getter: Callable[[list[str], Any], list[str]],
